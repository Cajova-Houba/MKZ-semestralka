...
/**
 * This class implements a Senet player.
 *
...
public class Player {
    ...
    public Player() {
        stones = new int[Constrains.MAX_NUMBER_OF_STONES];
    }
    ...
    public Player(String nick) {
        this(nick, new int[Constrains.MAX_NUMBER_OF_STONES]);
    }
    ...
    public byte[] getStateWord() {
        byte[] stateWord = new byte[Constrains.MAX_NUMBER_OF_STONES];
